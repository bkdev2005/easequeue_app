          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                navigatePage('Edit Profile', MaterialPageRoute(builder: (context)=> ProfileWidget(backButton: true,)), Icons.account_circle_outlined),
                navigatePage('Your Appointments', MaterialPageRoute(builder: (context)=> YourAppointmentsWidget()), Icons.assignment_late_outlined,),
                navigatePage('Favorite Businesses', MaterialPageRoute(builder: (context)=> const FavoriteBusinessWidget()), Icons.favorite_border_rounded,),
